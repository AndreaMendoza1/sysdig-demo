pipeline {
  ...
  stages {
    ...
    stage('Scan Image') {
      steps {
        sh "curl -s https://download.sysdig.com/stable/inline_scan.sh | bash -s -- analyze -s https://secure.sysdig.com -k 95bface6-74d7-418c-9154-ff64abbdd1af -P clouddemospe/podinfo:${env.BUILD_NUMBER}"
